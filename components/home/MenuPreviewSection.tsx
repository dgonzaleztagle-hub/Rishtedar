...
const FEATURED_DISHES = [
  {
    id: 'item-p01',
    name: 'Butter Chicken',
    nameEs: 'Pollo en crema de tomate y mantequilla',
    price: 15200,
    category: 'Pollo',
    tags: ['gluten-free'],
    isSignature: true,
  },
  {
    ...
    nameEs: 'Cordero magallánico con especias kashmiri',
    price: 21100,
    category: 'Cordero',
  ...
  },
  {
    id: 'item-e11',
    name: 'Paneer Tikka',
    nameEs: 'Queso de la casa asado en salsa tikka',
    price: 9800,
    category: 'Entradas',
    tags: ['vegetarian'],
    isSignature: false,
  },
  {
    id: 'item-a05',
    name: 'Murgh Biryani',
    nameEs: 'Arroz basmati con pollo y especias',
    price: 16900,
    category: 'Arroces & Biryanis',
    tags: ['gluten-free'],
    isSignature: false,
  },
  {
    id: 'item-v06',
    name: 'Dal Makhani',
    nameEs: 'Tres lentejas cremosas con mantequilla',
    price: 14900,
